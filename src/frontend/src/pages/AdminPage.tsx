import { CheckCircle, LogOut, TrendingUp, XCircle } from "lucide-react";
        ...
        {(["payments", "withdrawals", "deposits", "plans"] as Tab[]).map(
          (t) => (
            <button
              ...
              key={t}
              onClick={() => setTab(t)}
              className={`flex-1 py-3 text-xs font-semibold capitalize transition-colors ${tab === t ? "border-b-2" : "text-gray-500"}`}
              style={
              ...
              <div key={i} className="bg-white rounded-2xl p-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-3">
                  ...
                  <div className="col-span-2">
                    ...
                    {new Date(Number(p.submittedAt / 1000000n)).toLocaleString(
                      "en-IN",
                    )}
                  </div>
                </div>
                    ...
                    <button
                      ...
                      onClick={() =>
                        doAction(`pay-approve-${i}`, () =>
                          actor!.approvePaymentSubmission(BigInt(i)),
                        )
                      }
                    ...
                    <button
                      ...
                      onClick={() =>
                        doAction(`pay-reject-${i}`, () =>
                          actor!.rejectPaymentSubmission(BigInt(i)),
                        )
                      }
                      disabled={!!actionLoading}
                      className="flex-1 flex items-center justify-center gap-1 py-2 rounded-lg text-xs font-semibold text-white disabled:opacity-60"
            ...
            {[...withdrawals].reverse().map((w, i) => (
              ...
              <div key={i} className="bg-white rounded-2xl p-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-3">
                  ...
                  <div className="col-span-2">
                    <span className="text-gray-400">UPI:</span> {w.upiId}
                  </div>
                  <div className="col-span-2">
                    <span className="text-gray-400">Date:</span>{" "}
            ...
            {[...deposits].reverse().map((d, i) => (
              ...
              <div key={i} className="bg-white rounded-2xl p-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-3">
                  ...
                  <div className="col-span-2">
                    <span className="text-gray-400">Date:</span>{" "}
                    {new Date(Number(d.submittedAt / 1000000n)).toLocaleString(
                      "en-IN",
                    )}
                  </div>
                </div>
                    ...
                    <button
                      ...
                      onClick={() =>
                        doAction(`dep-approve-${i}`, () =>
                          actor!.approveDepositRequest(
                            BigInt(deposits.length - 1 - i),
                          ),
                        )
                      }
                      disabled={!!actionLoading}
